# Neovim config - adapted from [nvim-basic-ide](https://github.com/LunarVim/nvim-basic-ide)
...
For java development, make sure to install [java-debug](https://github.com/microsoft/java-debug) and [vscode-java-test](https://github.com/microsoft/vscode-java-test). For further instructions refer [nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls#debugger-via-nvim-dap) 
