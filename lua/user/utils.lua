...
M.run_code = function()
  ...
  local supportedFiletypes = {
    ...
    cpp = {
      compile_and_run_interactively = "clang++ -std=c++20 -DLOCAL % -o $fileBase && exec $fileBase",
      compile_and_run_with_input = "clang++ -std=c++20 -DLOCAL % -o $fileBase && ./$fileBase < input.txt | tee output.txt",
      compile_with_warning_flags = "clang++ -Wall -Wextra -pedantic -std=c++20 -O2 -Wshadow -Wformat=2 -Wfloat-equal -Wconversion -Wlogical-op -Wshift-overflow=2 -Wduplicated-cond -Wcast-qual -Wcast-align -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -D_FORTIFY_SOURCE=2 -fsanitize=address -fsanitize=undefined -fno-sanitize-recover -fstack-protector -DLOCAL %  -o $fileBase",
      compile_with_debug_info = "clang++ -g % -o $fileBase",
      run_compiled = "./$fileBase",
